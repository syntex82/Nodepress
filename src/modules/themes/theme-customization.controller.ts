...
export class ThemeCustomizationController {
  ...
  createImage(
    ...
    @Body() dto: CreateThemeCustomizationImageDto,
  ) {
  ...
  updateImage(
    @Param('id') id: string,
    @Body() dto: UpdateThemeCustomizationImageDto,
  ) {
  ...
  createBlock(
    @Param('themeId') themeId: string,
    @Body() dto: CreateThemeCustomizationBlockDto,
  ) {
  ...
  updateBlock(
    @Param('id') id: string,
    @Body() dto: UpdateThemeCustomizationBlockDto,
  ) {
  ...
  createLink(
    @Param('themeId') themeId: string,
    @Body() dto: CreateThemeCustomizationLinkDto,
  ) {
  ...
  updateLink(
    @Param('id') id: string,
    @Body() dto: UpdateThemeCustomizationLinkDto,
  ) {
